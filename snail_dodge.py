...
class Player(pygame.sprite.Sprite):
    ...
    def player_input(self):
        ...
        if keys[pygame.K_SPACE] and selt.rect.bottom >= 300:
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            ...
            if event.type == obstacle_timer:
                obstacle.group.add(Obstacle(choice(['fly','snail','snail','snail'])))
    ...
    if game_active:
        ...
        player.update()
        obstacle.group.draw(screen)
        obstacle.group.update()
